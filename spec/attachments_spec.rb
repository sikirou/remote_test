...
describe TicGitNG::Attachment do
  ...
  it "should be able to see an attachment that has been added to a ticket"
  it "should be able to get the attachment based on 'AttachmentID'"     #AttachmentID is a number
